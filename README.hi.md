...
3. इंस्टालेशन के बाद, DMG के अंदर `一键修复.command` पर डबल-क्लिक करें (यह स्वचालित रूप से नीचे दिए गए कमांड को चलाता है):

```bash
xattr -dr com.apple.quarantine /Applications/TelunKey.app
```

4. केवल स्क्रिप्ट विफल होने पर, टर्मिनल में मैन्युअल रूप से निम्न कमांड चलाएँ
5. TelunKey को पुनः लॉन्च करें
